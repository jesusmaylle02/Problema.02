...
namespace Problema._02
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Clear(); // Limpia la pantalla nuevamente
            ...
            do
            {
                ...
                Console.Clear(); // Limpia la pantalla antes de mostrar la nueva información
            ...
            Console.WriteLine("¡Muchas gracias por su tiempo!");
